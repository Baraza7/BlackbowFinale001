        ...
        <div className="relative flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden min-[500px]:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            ...
            >
              ...
              <a href="https://insurance.blackbowconsult.co.ke" target="_blank" rel="noopener noreferrer" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`}>Insurance</a>
          ...
          >
            ...
            >
              <nav className="flex flex-col space-y-4">
                ...
                <a href="https://insurance.blackbowconsult.co.ke" target="_blank" rel="noopener noreferrer" className={`font-medium text-base py-3 px-4 rounded-lg transition-all duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#FFBE00] hover:bg-gray-50' : 'text-white hover:text-[#FFBE00] hover:bg-white/10'}`}>Insurance</a>
